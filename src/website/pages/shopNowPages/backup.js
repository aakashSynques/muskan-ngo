    ...
    const handlePlaceOrder = async () => {
        if (validateForm()) {
            try {
                ...
                const body = {
                    customer_id: parsedTokenData.customer_id || '', // Set customer_id to parsedTokenData.customer_id if it exists, otherwise use an empty string
                    customer_email: formData.customer_email || parsedTokenData.customer_email,
