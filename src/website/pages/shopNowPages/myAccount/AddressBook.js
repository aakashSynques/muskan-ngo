...
import { Container, Row, Col, Card, CardBody, CardHeader, Spinner, Modal, Button } from 'react-bootstrap';
...
import { setAddressData1 } from '../../../../reducers/addressSlice';
...
const AddressBook = () => {
    ...
    const getAddressData = async () => {
        try {
            ...
            dispatch(setAddressData1(response.data.data));
    ...
    return (
        <>
                                    ...
                                    <>
                                        <div className="mt-4 bg-light p-4 border">
                                            {hasBillingAddress ? (
                                                ...
                                                <>
                                                    <h6 className=''>BILLING ADDRESS
                                                        <font className='main-color'
                                                            //  onClick={handleShowBillingModal}
                                                            onClick={handleShow}
                                                            style={{ cursor: "pointer" }}>( Add ) </font>
                                                    </h6>
            ...
            <BillAddress
                ...
                updateAddressData={handleBillingAdd}
            // initialData={hasBillingAddress || {}} 
            />
